...
if youre_choice_1 == 'да':
    ...
    if youre_choice_2 == 'да':
        ...
        time.sleep(3)
        print()
        print(f'\tВсе сели на большой, мягкий диван, чтобы посмотреть {film}. ')
        time.sleep(4)
        print()
...
time.sleep(5)
print('Ты спросила, что здесь происходит, но на это незнакомец улыбнулся и сказал, что искал дом по адресу Абрикосовая, 5')
time.sleep(5)
